...
<div class="container-fluid pricing" >
          ...
          <!-- Page Heading -->
          <h1 class="h3 mb-4 text-gray-800">Select Business Plans</h1>
		     <div class="row">
          ...
          <div class="col-lg-4 col-md-6">
            <div class="box">
              ...
              <div class="btn-wrap">
               ...
               <a href="#0"  class="btn-buy js-cd-add-to-cart" data-price="29">Add To Cart</a>
              </div>
            </div>
          </div>
          ...
          <div class="col-lg-4 col-md-6 mt-4 mt-md-0">
            <div class="box featured">
              ...
              <div class="btn-wrap">
               ...
               <a href="#1" class="btn-buy js-cd-add-to-cart"  data-price="99">Add To Cart</a>
              </div>
            </div>
          </div>
