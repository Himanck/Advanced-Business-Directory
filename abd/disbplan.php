            ...
            <div class="row">
                <div class="col-lg-12 text-center">
                    <div class="breadcrumb__text">
                        <h2 style="color: #ffffff !important;">Business Plans</h2>
...
<div class="container-fluid pricing" >
          ...
          <!-- Page Heading -->
          <h1 class="h3 mb-4 text-gray-800" style="margin-top:15px;">Business Plans</h1>
		     <div class="row">
    <div class="col-lg-4 col-md-6">
            <div class="box">
              ...
              <div class="btn-wrap">
               ...
               <a href="#" data-toggle="modal" data-target="#askModal"  class="btn-buy js-cd-add-to-cart">Select Plan</a>
              </div>
            </div>
          </div>
          ...
          <div class="col-lg-4 col-md-6 mt-4 mt-md-0">
            <div class="box featured">
              ...
              <div class="btn-wrap">
               ...
               <a href="#" data-toggle="modal" data-target="#askModal"  class="btn-buy js-cd-add-to-cart">Select Plan</a>  </div>
            </div>
          </div>
